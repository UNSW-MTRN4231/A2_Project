...
class YOLOv8Node(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Image, '/yolo_detections', 10)
        ...
        # Load YOLOv8 model
        self.model = torch.jit.load("/home/mtrn/4231/A2_Project/Computer_Vision/packages/src/yolov8_node/models/yolov8sseg.pt")
